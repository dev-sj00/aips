...
public record SearchByConditionCommand(String keyword, String topic, SearchSortType sortType, Integer pageFrom, Integer pageSize, SearchDateRange dateRange) {
}
