...
public interface ReportManagementRepository {
    ...
    Page<FindAllReportUsersResult> findAllReportByCommandWithOffsetAndLimit(FindAllReportUsersCommand command);
    Page<FindReportResult> findAllReportByUserPkWithOffsetAndLimit(int page, int pageSize, long userPk);


    ReportEntity updateReportStatusByReportPk(long reportPk, ReportStatus reportStatus);
    void updateReasonAndBanTypeByReportPk(long reportPk, String reason, BanType banType);
