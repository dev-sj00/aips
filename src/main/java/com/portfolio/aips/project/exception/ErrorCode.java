...
public enum ErrorCode {
    ...
    DELETE_INVITE_HISTORY_NOT_FOUND(HttpStatus.NOT_FOUND, "INVITE-002", "삭제할 검색 기록이 없습니다!"),
    INVALID_RATING_SCORE(HttpStatus.BAD_REQUEST, "RATING_001", "점수 값에 문제가 생겼습니다!"),
    NOT_FOUND_REASON_OR_BAN_TYPE(HttpStatus.NOT_FOUND, "REPORT_001", "정지 시간과 이유를 입력해주세요.");
