...
public class ReportManagementServiceImpl implements ReportManagementService {
    ...
    @Override
    public Page<FindAllReportUsersResult> findAllReportUsers(FindAllReportUsersCommand command) {
    ...
    @Override
    public Page<FindReportResult> findAllReportHistory(int page, int size, long targetUserPk) {
