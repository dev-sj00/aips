...
public interface ReportManagementService {
    ...
    Page<FindAllReportUsersWithPagingResult> findAllReportUsers(FindAllReportUsersCommand command);
    Page<FindAllReportHistoryWithPagingResult> findAllReportHistory(int page, int pageSize, long userPk);
